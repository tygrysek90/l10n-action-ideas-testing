...
def count_translations(dir_with_translations, print_info, reference_file):
    ...
    for lang in languages:
        ...
        if print_info:
            ...
            print(f'It's not expected for these to be translated, but if it makes sense for your\n')
            print(f'language, add a waiver for them on suppress_warning.py and open a PR explaining\n')
            print(f'why.\n')
